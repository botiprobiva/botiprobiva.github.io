...
[TelegramDB](https://t.me/tgdb_bot) — может находить общедоступные каналы и группы, а также видеть, в каких общедоступных чатах находится.
...
[AID ID CHEKER](https://t.me/CheckID_AIDbot) — Бот создан для быстрого получения ID пользователя тг.
