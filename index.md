...
[search4facesBot](https://telegram.dog/similarfacesBot) — тоже бесплатный бот сервиса search4faces ищет похожих по фотографии людей. Если он найдет фото в профиле VK, то покажет соответствующий профиль.
