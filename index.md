...
[Funstat Bot](/funstatbot/) — пробив пользователей мессенджера телеграм. Бот предоставляет информацию историю смены ID, находит сообщения в чатах, а также может найти телефонные номера, банковские карты. Умеет отслеживать активность пользователей и анализировать, где и что они пишут, определять их возраст и предпочтения, а также находить адреса электронной почты. Может показать, в каких чатах состоит пользователь, его любимый чат.
